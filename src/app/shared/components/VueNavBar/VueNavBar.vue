...
.vueNavBar {
  width: $nav-bar-width;
  /* Make the bar a bit slimmer than the original
     design-system default so it doesn't feel too tall. */
  min-height: 56px;
  color: #171717;
  padding: 0 $space-32;
...
@media (max-width: 768px) {
  .vueNavBar {
    padding: 0 $space-16; // 16px on tablets
  }
}

@media (max-width: 480px) {
  .vueNavBar {
    padding: 0 $space-8; // 8px on mobile
  }
}
