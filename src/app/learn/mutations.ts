import type { ILearnState } from './state';

export interface ILearnMutations {
    /**
     * put your mutations names, parameters and return values here, for example:
     * MY_MUTATION(context: ActionContext<ILearnState, IState>, param: any): void;
     */
}

export const LearnMutations: ILearnMutations = {
    /**
